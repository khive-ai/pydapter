...
import pytest
from pydantic import ValidationError, Field as PydanticField
...
class TestFieldTemplate:
    ...
    def test_as_nullable(self):
        ...
        assert Union[int, None] == field.annotation or field.annotation == Union[int, type(None)]
    ...
    def test_as_nullable_with_validator(self):
        ...
        TestModel = create_model(
            "TestModel",
            fields={"nullable_positive": field}
        )
...
class TestCommonTemplates:
    ...
    def test_username_template(self):
        ...
        TestModel = create_model(
            "TestModel",
            fields={"username": USERNAME_TEMPLATE}
        )
...
class TestAdvancedTemplateFeatures:
    ...
    def test_template_with_complex_validator_wrapping(self):
        ...
        TestModel = create_model(
            "TestModel",
            fields={"complex": complex_template.create_field("complex")}
        )
