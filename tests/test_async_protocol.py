...
class TestAsyncAdaptableFunctionality:
    ...
    @pytest.mark.asyncio
    async def test_async_adaptable_convenience_methods(self, async_model_class, async_sample_model):
...
class TestAsyncMocking:
    ...
    async def test_async_adapter_mocking(self, async_model_class, async_sample_model):
        ...
        mock_adapter.to_obj = AsyncMock(return_value={"id": 1, "name": "test", "value": 42.5})
