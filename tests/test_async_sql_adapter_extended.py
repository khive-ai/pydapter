...
class TestAsyncSQLAdapterExtended:
    ...
    def test_async_sql_table_helper(self):
        ...
        with patch("pydapter.extras.async_sql_.sa.Table", return_value=mock_table) as mock_sa_table:
            ...
            mock_sa_table.assert_called_once_with("test_table", mock_metadata, autoload_with=mock_metadata.bind)
        ...
        with patch("pydapter.extras.async_sql_.create_async_engine") as mock_create_engine:
            ...
            with patch("pydapter.extras.async_sql_.sa.MetaData") as mock_metadata_class:
                ...
                with patch.object(AsyncSQLAdapter, "_table") as mock_table_method:
                    ...
                    with patch("pydapter.extras.async_sql_.sa.select") as mock_select_func:
        ...
        with patch("pydapter.extras.async_sql_.create_async_engine") as mock_create_engine:
            ...
            with patch("pydapter.extras.async_sql_.sa.MetaData") as mock_metadata_class:
                ...
                with patch.object(AsyncSQLAdapter, "_table") as mock_table_method:
                    ...
                    with patch("pydapter.extras.async_sql_.sa.insert") as mock_insert_func:
